...
export default function About() {
    const boardMembers = [
        {
            name: 'Une Marie Stimo',
            role: 'Leder',
            img: une_img,
            mail: 'unestimo@xcomdata.no'
        },
        {
            name: 'Christine Schei Sunnevåg',
            role: 'Nestleder',
            img: christine_img,
            mail: 'christinesunnevag@xcomdata.no'
        },
        {
            name: 'Camilla Jensen',
            role: 'Økans',
            img: camilla_img,
            mail: 'camillajensen@xcomdata.no'
        },
        {
            name: 'Amalie Johansen Vik',
            role: 'Bedrift',
            img: amalie_img,
            mail: 'amalievik@xcomdata.no'
        },
        {
            name: 'Kaisa Øyre Larsen',
            role: 'Bedrift',
            img: kaisa_img,
            mail: 'kaisalarsen@xcomdata.no'
        },
        {
            name: 'Sindy Shan',
            role: 'Bedrift',
            img: sindy_img,
            mail: 'sindyshan@xcomdata.no'
        },
        {
            name: 'Siri Wikeland',
            role: 'Bedrift',
            img: siri_img,
            mail: 'siriwikeland@xcomdata.no'
        },
        {
            name: 'Anette Wiken Lund',
            role: 'Sponsor',
            img: anette_img,
            mail: 'anettelund@xcomdata.no'
        },
        {
            name: 'Molly Vangen',
            role: 'Sponsor',
            img: molly_img,
            mail: 'mollyvangen@xcomdata.no'
        },
        {
            name: 'Hanna Katle Fjon',
            role: 'Sponsor',
            img: hannaF_img,
            mail: 'hannafjon@xcomdata.no'
        },
        {
            name: 'Karos Hemn',
            role: 'Turansvarlig',
            img: karos_img,
            mail: 'karoshemn@xcomdata.no'
        },
        {
            name: 'Hanna Kongelf',
            role: 'Tur',
            img: hannaK_img,
            mail: 'hannakongelf@xcomdata.no'
        },
        {
            name: 'Julie Amundsen Wolff',
            role: 'Tur',
            img: julie_img,
            mail: 'juliewolff@xcomdata.no'
        },
        {
            name: 'Oda Bang-Olsen',
            role: 'Tur',
            img: oda_img,
            mail: 'odaolsen@xcomdata.no'
        },
        {
            name: 'Tobias Osvik Brekke',
            role: 'Webansvarlig',
            img: tobias_img,
            mail: 'tobias@xcomdata.no'
        },
        {
            name: 'Jenny Müller',
            role: 'Web',
            img: jenny_img,
            mail: 'jennymuller@xcomdata.no'
        },
        {
            name: 'Maria Wembstad',
            role: 'Festansvarlig',
            img: maria_img,
            mail: 'mariawembstad@xcomdata.no'
        },
        {
            name: 'Johan Legreid',
            role: 'Fest',
            img: johan_img,
            mail: 'johan@xcomdata.no'
        },
        {
            name: 'Simen Steinsland',
            role: 'Fest',
            img: simen_img,
            mail: 'simensteinsland@xcomdata.no'
        }
    ]
